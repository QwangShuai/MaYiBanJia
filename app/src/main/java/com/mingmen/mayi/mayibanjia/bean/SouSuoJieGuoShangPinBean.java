...
public class SouSuoJieGuoShangPinBean {

        private List<ZhengchangBean> commodity_sales;
        private List<ZhengchangBean> pice_one;
        private List<ZhengchangBean> zhengchang;
        private List<ZhengchangBean> star_evaluation;

        public List<ZhengchangBean> getCommodity_sales() {
            return commodity_sales;
        }

        public void setCommodity_sales(List<ZhengchangBean> commodity_sales) {
            this.commodity_sales = commodity_sales;
        }

        public List<ZhengchangBean> getPice_one() {
            return pice_one;
        }

        public void setPice_one(List<ZhengchangBean> pice_one) {
        ...
        public List<ZhengchangBean> getStar_evaluation() {
            return star_evaluation;
        }

        public void setStar_evaluation(List<ZhengchangBean> star_evaluation) {
        ...
        public static class ZhengchangBean {
             ...
             * shuliang : null
             * avgPrice : null
             * hostphoto : http://pbn4jedp4.bkt.clouddn.com/0c844d07f7ba4bf0b5aaa1a6928c440210.jpg?e=1535966290&token=EetUisYqZq45CDj_OHzI3G5FPRsPp4WCEl3FtAEu:D9s2wX5cqu8_z9rc25LRPmPdC8I=
             * avgNum : null
             * hPicture : null
             * dPicture : null
             * split_type : null
