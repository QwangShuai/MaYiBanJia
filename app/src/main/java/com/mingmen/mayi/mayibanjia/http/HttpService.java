...
//                                                    @Query("order_audit_state") String order_audit_state);
    ...
    Observable<ResultModel<String>> fabushangpin(@Query("user_token") String user_token,
                                                 ...
                                                 @Query("choose_specifications") String choose_specifications,
                                                 @Query("pack_standard_one") String pack_standard_one,
                                                 @Query("specOneNum") String specOneNum,
                                                 @Query("pack_standard_two") String pack_standard_two,
                                                 @Query("specTwoNum") String specTwoNum,
                                                 @Query("pack_standard_tree") String pack_standard_tree,
                                                 @Query("specThreeNum") String specThreeNum,
                                                 @Query("ration_one") String ration_one,
                                                 @Query("pice_one") String pice_one,
                                                 @Query("ration_two") String ration_two,
                                                 @Query("pice_two") String pice_two,
                                                 @Query("ration_three") String ration_three,
                                                 @Query("pice_three") String pice_three,
