 ...
 */
//店铺名称模糊查询
public class DianPuMohuAdapter extends  RecyclerView.Adapter<DianPuMohuAdapter.ViewHolder>{
    private ViewHolder viewHolder;
    private Context mContext;
    private List<DianPuBean> mList;
    private OnItemClickListener mOnItemClickListener;
    public DianPuMohuAdapter(Context mContext, List<DianPuBean> list) {
    ...
    @Override
    public DianPuMohuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        DianPuBean dianPuBean = mList.get(position);
