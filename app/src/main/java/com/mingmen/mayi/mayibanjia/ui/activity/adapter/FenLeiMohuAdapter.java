...
public class FenLeiMohuAdapter extends  RecyclerView.Adapter<FenLeiMohuAdapter.ViewHolder>{
    private ViewHolder viewHolder;
    private Context mContext;
    private List<FCGName> mList;
    private OnItemClickListener mOnItemClickListener;
    public FenLeiMohuAdapter(Context mContext, List<FCGName> list) {
    ...
    @Override
    public FenLeiMohuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
