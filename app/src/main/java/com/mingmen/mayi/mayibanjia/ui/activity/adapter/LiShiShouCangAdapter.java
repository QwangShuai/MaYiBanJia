...
public class LiShiShouCangAdapter extends RecyclerView.Adapter<LiShiShouCangAdapter.ViewHolder> {

    private ViewHolder viewHolder;
    private Context mContext;
    private List<XiTongTuiJianBean.CcListBean> mList;

    public LiShiShouCangAdapter(Context mContext, List<XiTongTuiJianBean.CcListBean> list) {
...
//        holder.tvRenminbi.setText(data.getPrice());
        ...
        holder.tvShijian.setText(data.getCreat_time());
