...
public class QuhuomaAdapter extends RecyclerView.Adapter<QuhuomaAdapter.ViewHolder> {

    private ViewHolder viewHolder;
    private Context mContext;
    private List<GHOrderBean.ZilistBean.TwoCodeBean> mList;


    private OnItemClickListener mOnItemClickListener;

    public QuhuomaAdapter(Context mContext, List<GHOrderBean.ZilistBean.TwoCodeBean> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        GHOrderBean.ZilistBean.TwoCodeBean data = mList.get(position);
...
//        }
        holder.tvMing.setText("取货码 : "+data.getOnlyCode() + "");
