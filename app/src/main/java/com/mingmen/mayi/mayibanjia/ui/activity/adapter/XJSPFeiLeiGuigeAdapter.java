...
public class XJSPFeiLeiGuigeAdapter extends RecyclerView.Adapter<XJSPFeiLeiGuigeAdapter.ViewHolder> {
    private ViewHolder viewHolder;
    private CallBack mCallBack;
    private String xuanzhongid = "";
    private Context mContext;
    private List<ShangPinSousuoMohuBean> list;

    public XJSPFeiLeiGuigeAdapter(Context mContext, List<ShangPinSousuoMohuBean> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final ShangPinSousuoMohuBean bean = list.get(position);
//            if (bean.isSelect()) {
...
//            }
    ...
    public XJSPFeiLeiGuigeAdapter setCallBack(CallBack mCallBack) {
    ...
    public interface CallBack {
        void xuanzhong(ShangPinSousuoMohuBean msg);
    }
