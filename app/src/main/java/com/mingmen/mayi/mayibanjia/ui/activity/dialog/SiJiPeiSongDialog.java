...
public class SiJiPeiSongDialog extends BaseFragmentDialog implements View.OnClickListener{
    ...
    public SiJiPeiSongDialog init(String xuanxiang1, String xuanxiang2, String xuanxiang3, String xuanxiang4) {
    ...
    public SiJiPeiSongDialog setTop(int top) {
        this.top = top;
        return this;
    }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.cancel_view){
            ...
            changeView(tvXuanxiang2,v, "1401");
            changeView(tvXuanxiang3,v, "1402");
            changeView(tvXuanxiang4,v, "1403");
        }
    }


    public SiJiPeiSongDialog setActivity(SiJiActivity activity) {
