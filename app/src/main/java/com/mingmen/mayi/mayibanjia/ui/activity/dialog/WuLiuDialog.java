...
public class WuLiuDialog extends BaseFragmentDialog implements View.OnClickListener{
    ...
    public WuLiuDialog init(String xuanxiang1, String xuanxiang2, String xuanxiang3, String xuanxiang4) {
    ...
    public WuLiuDialog setTop(int top) {
        this.top = top;
        return this;
    }
...
//            activity.shuaxinWuLiu(s);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.cancel_view){
            ...
            changeView(tvXuanxiang2,v, "0");
            changeView(tvXuanxiang3,v, "1");
            changeView(tvXuanxiang4,v, "2");
        }
    }


    public WuLiuDialog setActivity(WuLiuActivity activity) {
