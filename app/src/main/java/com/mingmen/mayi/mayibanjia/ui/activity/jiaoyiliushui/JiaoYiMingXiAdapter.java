...
public class JiaoYiMingXiAdapter extends RecyclerView.Adapter<JiaoYiMingXiAdapter.ViewHolder> {

    private ViewHolder viewHolder;
    private Context mContext;
    private List<JYMXBean> mList;

    public JiaoYiMingXiAdapter(Context mContext, List<JYMXBean> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final JYMXBean bean = mList.get(position);
