...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int seleterino=0;//添加文字高亮显示
	...
	private int tabBackgroundResId = R.drawable.indicator_drawable_selected;
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				 ...
				 */
				if (seleterino == i) {
					tab.setTextColor(getResources().getColor(R.color.zangqing));
				} else {
