...
public class ChatView extends RelativeLayout {
    ...
    public ChatView(Activity activity) {
        super(activity);
        LayoutInflater.from(activity).inflate(R.layout.item_xuanfu, this);
//        setBackgroundResource(R.drawable.fillet_solid_zangqing_tuoyuan);
        wm = (WindowManager) activity.getSystemService(Context.WINDOW_SERVICE);
        tvNo = (TextView) findViewById(R.id.tv_gwc_no) ;
        llGwc = (LinearLayout) findViewById(R.id.ll_gwc) ;
...
//        wmParams.height = dpi;
    ...
    public void setTextNo(String no){
        if(StringUtil.isValid(no)&&!no.equals("0")){
            tvNo.setText(no);
            tvNo.setVisibility(VISIBLE);
        } else {
            tvNo.setVisibility(GONE);
        }
...
//    public void setChatViewOnClick(OnClickListener listener){
//        llGwc.setOnClickListener(listener);
//    }
